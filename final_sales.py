...
#---------------------------------------------------------------
st.header("User Inputs for outlet sales prediction")
st.write("\n")

st.subheader("Item Weight:")
wei=st.number_input("",value=2.0)

st.subheader("Fat Content in the Item:")
fat=st.selectbox("",["Low Fat","Regular"])

st.subheader("Visibility of the brand:")
...
st.subheader("Outlet type (size of export)")
ot=st.selectbox("",['Medium', 'Small', 'High'])

st.subheader("Outlet location type:")
oloc=st.radio("",['Tier 3', 'Tier 2', 'Tier 1'])
